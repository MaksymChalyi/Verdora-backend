...
public class AuthController {
    ...
    @Operation(
            ...
            description =
                    "Registers a new user and authenticates them by setting accessToken and refreshToken cookies")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
    ...
    public ResponseEntity<BaseResponse<SignInResponse>> login(
        ...
        return ResponseEntity.ok(
                BaseResponseFactory.success(
                        HttpStatus.OK, "Login successful", new SignInResponse(result.email())));
    }
    ...
    public ResponseEntity<BaseResponse<Void>> refresh(
        ...
        return ResponseEntity.ok(BaseResponseFactory.success(HttpStatus.OK, "Token refreshed"));
    }

    @Operation(summary = "Logout", description = "Clears accessToken and refreshToken cookies")
    @ApiResponse(
            responseCode = "200",
